...
// FROZEN (no-fake-data): internal seed/test fixtures carry a literal
// "[SEED]" marker in their title/name. They must NEVER render on the
// user-facing Results surface. Observed live (v c8d4b15): a NYC "house
// cleaning" search surfaced "[SEED] Paulo Plumber — 24/7 Miami" and
// "[SEED] Cara Cleaner — Austin deep clean". The notSeedFixture guard
// filters them on BOTH the request-scoped and legacy browse paths.
