...
- If the user says "my home", "home", "my place", "default", "same as last time", "usual spot" — and a default_address is provided in the input JSON — use that default_address as the where value. Don't ask again. Acknowledge it ("📍 Home ✓").
