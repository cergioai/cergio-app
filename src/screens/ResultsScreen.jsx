...
export function ResultsScreen() {
  ...
  // CERGIO-GUARD (2026-07-17, no-fake-data rule): internal seed/test
  // fixtures carry a literal "[SEED]" marker in their title/name. They
  // must NEVER render on a real user-facing Results surface (the "no
  // mock data on real screens" FROZEN rule). Observed live (v c8d4b15):
  // a NYC "house cleaning" search surfaced "[SEED] Paulo Plumber — 24/7
  // Miami" and "[SEED] Cara Cleaner — Austin deep clean" via the
  // free/browse path. Guard BOTH the request-scoped and legacy browse
  // paths, mirroring notBlockedSvc.
