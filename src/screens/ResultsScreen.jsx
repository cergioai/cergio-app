...
export function ResultsScreen() {
  ...
  // mock data on real screens" FROZEN rule). Observed live: a NYC
  // "house cleaning" search surfaced "[SEED] Paulo Plumber — 24/7 Miami"
  // and "[SEED] Cara Cleaner — Austin deep clean" via the free/browse
  // path. Guard BOTH the request-scoped and legacy browse paths,
  // mirroring notBlockedSvc.
