    ...
    <div className="flex-1 flex flex-col bg-cream">
              ...
              return (
                <div key={c.id} className="px-5 py-3 flex items-center gap-3 border-b border-bdr">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[15px] font-extrabold text-black truncate">{c.name}</p>
                    {c.is_connector && (
                      <p className="text-[11.5px] text-gd font-extrabold inline-flex items-center gap-1 mt-0.5">
      ...
      <div className="shrink-0 bg-white border-t border-bdr px-5 pt-3 pb-5">
        {selectedList.length === 0 ? (
          <p className="text-center text-[12.5px] text-b3 font-medium py-2">
          ...
          <>
            ...
            <button
              ...
              className="w-full bg-salmon text-white rounded-[24px] py-4 text-[17px] font-extrabold
